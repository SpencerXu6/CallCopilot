...
export const UI: Record<string, LangStrings> = {
  ...
  Spanish: {
    ...
    cancel: 'Cancelar',
    presets: ['Cambiar cubo de basura', 'Cuenta bancaria', 'Cita médica', 'Problema de factura', 'Cambiar dirección', 'Cancelar servicio'],
  },
  French: {
    ...
    goalSub: 'Avec quoi avez-vous besoin d\'aide lors de cet appel ?',
    ...
    cancel: 'Annuler',
    presets: ['Changer poubelle', 'Compte bancaire', 'Rendez-vous médecin', 'Problème de facture', 'Changer d\'adresse', 'Annuler service'],
  },
  Korean: {
    heroTitle: '모든 영어 통화를\n자신 있게',
  ...
  Japanese: {
    ...
    cancel: 'キャンセル',
    presets: ['ゴミ箱変更', '銀行口座問題', '医師の予約', '請求書問題', '住所変更', 'サービス解約'],
  },
  Portuguese: {
